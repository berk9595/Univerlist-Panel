      ...
      <div className={classes.root}>
        ...
        >
          <Toolbar disableGutters={!this.state.open}>
            ...
            <Typography variant="subtitle1" style={{color:'#4C4C50',fontWeight:500}}  className={classes.montserrat}>
              UniverList
            </Typography>
        ...
        >
          ...
          <Grid container><Typography style={{paddingLeft:16}}>Menu</Typography></Grid>
          ...
          <List>
              <ListItem button>
                <ListItemIcon><InboxIcon style={{color:'#b5b1dd'}}/></ListItemIcon>
                <ListItemText ><Typography style={{color:'#b5b1dd'}} className={classes.montserrat}>Edit</Typography></ListItemText>
              </ListItem>
                <Divider />
               <ListItem button >
